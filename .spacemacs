...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(htmlize matlab-mode org2blog)   
...
you should place your code here."
  ...
  (setq org2blog/wp-blog-alist
      '(
      	("wordpress"
         :url "https://zyeeee.wordpress.com/xmlrpc.php"
         :username "yzt9zju@gmail.com"
         :password "yezhouteng9"
  ...
  (setq org-agenda-files (list "/home/yeldon/MYORG/tasks.org"))  
